...
export class PhotoPage {
  ...
  constructor(
    ...
    public loadingCtrl: LoadingController) {
      ...
      this.man=this.navParams.get('man');
      this.woman=this.navParams.get('woman');
      this.phone=this.navParams.get('phone');
  }

  continue() {
    this.navCtrl.push(QRScannerPage,{
      nom:this.nom,date:this.date,man:this.man,woman:this.woman,phone:this.phone});
  }
